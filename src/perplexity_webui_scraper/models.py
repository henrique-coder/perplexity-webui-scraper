...
class ModelType:
    ...
    class Sonar(ModelBase):
        """Perplexity's fast model (Pro)"""

        _identifier = "experimental"
        _mode = "copilot"

    class Claude40Sonnet(ModelBase):
        """Anthropic's advanced model (Pro)"""

        _identifier = "claude2"
        _mode = "copilot"

    class GPT5(ModelBase):
        """OpenAI's latest model (Pro)"""

        _identifier = "gpt5"
        _mode = "copilot"

    class Gemini25Pro0605(ModelBase):
        """Google's latest model (Pro)"""

        _identifier = "gemini2flash"
        _mode = "copilot"

    class Claude40SonnetThinking(ModelBase):
        """Anthropic's reasoning model (Pro & Reasoning)"""

        _identifier = "claude37sonnetthinking"
        _mode = "copilot"

    class Grok4(ModelBase):
        """xAI's latest, most powerful reasoning model (Pro & Reasoning)"""

        _identifier = "grok4"
        _mode = "copilot"

    class o3(ModelBase):
        """OpenAI's reasoning model (Pro & Reasoning)"""
