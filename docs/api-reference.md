...
| --- | --- | --- | --- | --- | --- | --- |
| `perplexity/best` | `turbo` | perplexity | `true` | free | `available` | 2026-09-13T23:12:46.982064Z |
| `perplexity/deep-research` | `pplx_alpha` | perplexity | `true` | pro | `available` | 2026-09-13T23:12:51.081351Z |
| `openai/gpt-5.6-terra` | `gpt56_terra` | openai | `true` | pro | `available` | 2026-09-13T23:12:54.800629Z |
| `openai/gpt-5.6-terra-thinking` | `gpt56_terra_thinking` | openai | `true` | pro | `available` | 2026-09-13T23:12:59.855822Z |
| `openai/gpt-5.6-sol` | `gpt56_sol` | openai | `true` | max | `available` | 2026-09-13T23:13:03.654886Z |
| `openai/gpt-5.6-sol-thinking` | `gpt56_sol_thinking` | openai | `true` | max | `available` | 2026-09-13T23:13:08.031580Z |
| `google/gemini-3.8-flash` | `gemini38flash` | google | `true` | pro | `available` | 2026-09-13T23:13:11.992982Z |
| `google/gemini-3.8-flash-thinking` | `gemini38flashthinking` | google | `true` | pro | `available` | 2026-09-13T23:13:19.382663Z |
| `anthropic/claude-sonnet-5` | `claude50sonnet` | anthropic | `true` | pro | `available` | 2026-09-13T23:13:23.003285Z |
| `anthropic/claude-sonnet-5-thinking` | `claude50sonnetthinking` | anthropic | `true` | pro | `available` | 2026-09-13T23:13:27.466606Z |
| `anthropic/claude-opus-5` | `claude50opus` | anthropic | `true` | max | `available` | 2026-09-13T23:13:31.135570Z |
| `anthropic/claude-opus-5-thinking` | `claude50opusthinking` | anthropic | `true` | max | `available` | 2026-09-13T23:13:34.923562Z |
| `moonshot/kimi-k3-thinking` | `kimik3thinking` | moonshot | `true` | pro | `available` | 2026-09-13T23:13:39.295326Z |
| `z-ai/glm-5.3` | `glm_5_3_thinking` | z-ai | `true` | pro | `available` | 2026-09-13T23:13:43.154248Z |
| `x-ai/grok-4.6` | `grok46low` | x-ai | `true` | pro | `available` | 2026-09-13T23:13:47.724677Z |
| `x-ai/grok-4.6-thinking` | `grok46medium` | x-ai | `true` | pro | `available` | 2026-09-13T23:13:51.201091Z |
| `nvidia/nemotron-3-ultra-thinking` | `nv_nemotron_3_ultra` | nvidia | `true` | pro | `available` | 2026-09-13T23:13:55.789723Z |
| `google/gemini-3.7-flash` | `gemini37flash` | google | `false` | pro | `available` | 2026-09-13T23:13:59.271156Z |
| `google/gemini-3.7-flash-thinking` | `gemini37flashthinking` | google | `false` | pro | `available` | 2026-09-13T23:14:03.414284Z |
| `perplexity/sonar-2` | `experimental` | perplexity | `false` | pro | `available` | 2026-09-13T23:14:07.384667Z |
| `z-ai/glm-5.2` | `glm_5_2` | z-ai | `false` | pro | `available` | 2026-09-13T23:14:11.455015Z |
| `google/gemini-3.1-pro-thinking-high` | `gemini31pro_high` | google | `false` | pro | `available` | 2026-09-13T23:14:15.526678Z |
| `x-ai/grok-4.5` | `grok45low` | x-ai | `false` | pro | `available` | 2026-09-13T23:14:19.090362Z |
| `x-ai/grok-4.5-thinking` | `grok45medium` | x-ai | `false` | pro | `available` | 2026-09-13T23:14:23.385082Z |
| `anthropic/claude-opus-4.8` | `claude48opus` | anthropic | `false` | max | `available` | 2026-09-13T23:14:27.434038Z |
| `anthropic/claude-opus-4.8-thinking` | `claude48opusthinking` | anthropic | `false` | max | `available` | 2026-09-13T23:14:34.434827Z |
| `google/gemini-3.1-pro-thinking-low` | `gemini31pro_low` | google | `false` | pro | `available` | 2026-09-13T23:14:37.828406Z |
| `moonshot/kimi-k2.6-instant` | `kimik26instant` | moonshot | `false` | pro | `available` | 2026-09-13T23:14:42.640538Z |
| `moonshot/kimi-k2.6-thinking` | `kimik26thinking` | moonshot | `false` | pro | `available` | 2026-09-13T23:14:47.259175Z |
| `nvidia/nemotron-3-super-thinking` | `nv_nemotron_3_super` | nvidia | `false` | pro | `available` | 2026-09-13T23:14:51.249396Z |
| `openai/gpt-5.4` | `gpt54` | openai | `false` | pro | `available` | 2026-09-13T23:14:55.227656Z |
| `openai/gpt-5.4-thinking` | `gpt54_thinking` | openai | `false` | pro | `available` | 2026-09-13T23:14:59.198145Z |
| `openai/gpt-5.5-thinking` | `gpt55_thinking` | openai | `false` | max | `available` | 2026-09-13T23:15:03.401542Z |
| `anthropic/claude-opus-4.7` | `claude47opus` | anthropic | `false` | max | `available` | 2026-09-13T23:15:06.850877Z |
| `anthropic/claude-opus-4.7-thinking` | `claude47opusthinking` | anthropic | `false` | max | `available` | 2026-09-13T23:15:10.780893Z |
| `anthropic/claude-sonnet-4.6` | `claude46sonnet` | anthropic | `false` | pro | `available` | 2026-09-13T23:15:14.845654Z |
| `anthropic/claude-sonnet-4.6-thinking` | `claude46sonnetthinking` | anthropic | `false` | pro | `available` | 2026-09-13T23:15:19.994628Z |
| `openai/gpt4o` | `gpt4o` | openai | `false` | unknown | `available` | 2026-09-13T23:15:24.125802Z |
| `openai/gpt41` | `gpt41` | openai | `false` | unknown | `available` | 2026-09-13T23:15:28.101680Z |
| `openai/gpt5` | `gpt5` | openai | `false` | unknown | `available` | 2026-09-13T23:15:32.360214Z |
| `openai/gpt5-thinking` | `gpt5_thinking` | openai | `false` | unknown | `available` | 2026-09-13T23:15:36.452512Z |
| `openai/gpt51` | `gpt51` | openai | `false` | unknown | `available` | 2026-09-13T23:15:40.309049Z |
| `openai/gpt51-thinking` | `gpt51_thinking` | openai | `false` | unknown | `available` | 2026-09-13T23:15:44.360139Z |
| `openai/gpt51-low-thinking` | `gpt51_low_thinking` | openai | `false` | unknown | `available` | 2026-09-13T23:15:48.287810Z |
| `openai/gpt5-mini` | `gpt5_mini` | openai | `false` | unknown | `available` | 2026-09-13T23:15:52.567525Z |
| `openai/gpt5-nano` | `gpt5_nano` | openai | `false` | unknown | `available` | 2026-09-13T23:15:56.799784Z |
| `openai/gpt5-pro` | `gpt5_pro` | openai | `false` | unknown | `available` | 2026-09-13T23:16:01.068556Z |
| `openai/gpt52` | `gpt52` | openai | `false` | unknown | `available` | 2026-09-13T23:16:04.887935Z |
| `openai/gpt52-thinking` | `gpt52_thinking` | openai | `false` | unknown | `available` | 2026-09-13T23:16:11.737370Z |
| `openai/gpt52-pro` | `gpt52_pro` | openai | `false` | unknown | `available` | 2026-09-13T23:16:16.305460Z |
| `openai/gpt55` | `gpt55` | openai | `false` | unknown | `available` | 2026-09-13T23:16:20.110289Z |
| `anthropic/claude2` | `claude2` | anthropic | `false` | unknown | `available` | 2026-09-13T23:16:23.835408Z |
| `anthropic/claude37sonnetthinking` | `claude37sonnetthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T23:16:28.168102Z |
| `anthropic/claude40sonnetthinking` | `claude40sonnetthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T23:16:32.348336Z |
| `google/gemini25pro` | `gemini25pro` | google | `false` | unknown | `available` | 2026-09-13T23:16:36.267089Z |
| `google/gemini30pro` | `gemini30pro` | google | `false` | unknown | `available` | 2026-09-13T23:16:40.189797Z |
| `google/gemini30flash` | `gemini30flash` | google | `false` | unknown | `available` | 2026-09-13T23:16:44.593098Z |
| `google/gemini30flash-high` | `gemini30flash_high` | google | `false` | unknown | `available` | 2026-09-13T23:16:48.598801Z |
| `google/gemini35flash` | `gemini35flash` | google | `false` | unknown | `available` | 2026-09-13T23:16:52.628156Z |
| `google/gemini35flash-medium` | `gemini35flash_medium` | google | `false` | unknown | `available` | 2026-09-13T23:16:56.700528Z |
| `google/gemini35flash-high` | `gemini35flash_high` | google | `false` | unknown | `available` | 2026-09-13T23:17:00.687539Z |
| `x-ai/grok` | `grok` | x-ai | `false` | unknown | `available` | 2026-09-13T23:17:04.535073Z |
| `anthropic/claude40opus` | `claude40opus` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:08.771164Z |
| `anthropic/claude40opusthinking` | `claude40opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:12.509100Z |
| `anthropic/claude41opus` | `claude41opus` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:16.178303Z |
| `anthropic/claude41opusthinking` | `claude41opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:20.159256Z |
| `anthropic/claude45opus` | `claude45opus` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:24.494875Z |
| `anthropic/claude45opusthinking` | `claude45opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:28.400043Z |
| `anthropic/claude46opus` | `claude46opus` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:32.157453Z |
| `anthropic/claude46opusthinking` | `claude46opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:36.648850Z |
| `anthropic/claude45sonnet` | `claude45sonnet` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:40.515816Z |
| `anthropic/claude45sonnetthinking` | `claude45sonnetthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T23:17:44.569185Z |
| `anthropic/claude45haiku` | `claude45haiku` | anthropic | `false` | unknown | `unavailable` | 2026-09-13T23:17:48.684196Z |
| `anthropic/claude45haikuthinking` | `claude45haikuthinking` | anthropic | `false` | unknown | `unavailable` | 2026-09-13T23:17:51.371840Z |
| `moonshot/kimik2thinking` | `kimik2thinking` | moonshot | `false` | unknown | `available` | 2026-09-13T23:17:55.379339Z |
| `moonshot/kimik25thinking` | `kimik25thinking` | moonshot | `false` | unknown | `available` | 2026-09-13T23:18:01.032604Z |
| `x-ai/grok4` | `grok4` | x-ai | `false` | unknown | `available` | 2026-09-13T23:18:05.567750Z |
| `x-ai/grok4nonthinking` | `grok4nonthinking` | x-ai | `false` | unknown | `available` | 2026-09-13T23:18:09.535694Z |
| `x-ai/grok41reasoning` | `grok41reasoning` | x-ai | `false` | unknown | `available` | 2026-09-13T23:18:13.434016Z |
| `x-ai/grok41nonreasoning` | `grok41nonreasoning` | x-ai | `false` | unknown | `available` | 2026-09-13T23:18:17.917424Z |
| `openai/o4mini` | `o4mini` | openai | `false` | unknown | `available` | 2026-09-13T23:18:21.843033Z |
| `openai/o3pro` | `o3pro` | openai | `false` | unknown | `available` | 2026-09-13T23:18:26.139147Z |
