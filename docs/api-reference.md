...
| --- | --- | --- | --- | --- | --- | --- |
| `perplexity/best` | `turbo` | perplexity | `true` | free | `available` | 2026-09-13T19:51:19.057910Z |
| `perplexity/deep-research` | `pplx_alpha` | perplexity | `true` | pro | `available` | 2026-09-13T19:50:53.931937Z |
| `openai/gpt-5.6-terra` | `gpt56_terra` | openai | `true` | pro | `available` | 2026-09-13T19:37:29.434502Z |
| `openai/gpt-5.6-terra-thinking` | `gpt56_terra_thinking` | openai | `true` | pro | `available` | 2026-09-13T19:37:39.344800Z |
| `openai/gpt-5.6-sol` | `gpt56_sol` | openai | `true` | max | `available` | 2026-09-13T19:37:49.191163Z |
| `openai/gpt-5.6-sol-thinking` | `gpt56_sol_thinking` | openai | `true` | max | `available` | 2026-09-13T19:37:59.368027Z |
| `google/gemini-3.8-flash` | `gemini38flash` | google | `true` | pro | `available` | 2026-09-13T19:38:09.870735Z |
| `google/gemini-3.8-flash-thinking` | `gemini38flashthinking` | google | `true` | pro | `available` | 2026-09-13T19:38:14.544356Z |
| `anthropic/claude-sonnet-5` | `claude50sonnet` | anthropic | `true` | pro | `available` | 2026-09-13T19:38:24.302138Z |
| `anthropic/claude-sonnet-5-thinking` | `claude50sonnetthinking` | anthropic | `true` | pro | `available` | 2026-09-13T19:38:34.118565Z |
| `anthropic/claude-opus-5` | `claude50opus` | anthropic | `true` | max | `available` | 2026-09-13T19:38:43.900501Z |
| `anthropic/claude-opus-5-thinking` | `claude50opusthinking` | anthropic | `true` | max | `available` | 2026-09-13T19:38:53.667825Z |
| `moonshot/kimi-k3-thinking` | `kimik3thinking` | moonshot | `true` | pro | `available` | 2026-09-13T19:39:03.507218Z |
| `z-ai/glm-5.3` | `glm_5_3_thinking` | z-ai | `true` | pro | `available` | 2026-09-13T19:39:13.397094Z |
| `x-ai/grok-4.6` | `grok46low` | x-ai | `true` | pro | `available` | 2026-09-13T19:39:23.139648Z |
| `x-ai/grok-4.6-thinking` | `grok46medium` | x-ai | `true` | pro | `available` | 2026-09-13T19:39:32.894208Z |
| `nvidia/nemotron-3-ultra-thinking` | `nv_nemotron_3_ultra` | nvidia | `true` | pro | `available` | 2026-09-13T19:39:42.666584Z |
| `google/gemini-3.7-flash` | `gemini37flash` | google | `false` | pro | `available` | 2026-09-13T19:39:52.446292Z |
| `google/gemini-3.7-flash-thinking` | `gemini37flashthinking` | google | `false` | pro | `available` | 2026-09-13T19:40:02.285061Z |
| `perplexity/sonar-2` | `experimental` | perplexity | `false` | pro | `available` | 2026-09-13T19:40:12.067771Z |
| `z-ai/glm-5.2` | `glm_5_2` | z-ai | `false` | pro | `available` | 2026-09-13T19:40:21.918449Z |
| `google/gemini-3.1-pro-thinking-high` | `gemini31pro_high` | google | `false` | pro | `available` | 2026-09-13T19:40:33.018069Z |
| `x-ai/grok-4.5` | `grok45low` | x-ai | `false` | pro | `available` | 2026-09-13T19:40:42.851821Z |
| `x-ai/grok-4.5-thinking` | `grok45medium` | x-ai | `false` | pro | `available` | 2026-09-13T19:40:52.653495Z |
| `anthropic/claude-opus-4.8` | `claude48opus` | anthropic | `false` | max | `available` | 2026-09-13T19:41:02.443376Z |
| `anthropic/claude-opus-4.8-thinking` | `claude48opusthinking` | anthropic | `false` | max | `available` | 2026-09-13T19:41:12.230861Z |
| `google/gemini-3.1-pro-thinking-low` | `gemini31pro_low` | google | `false` | pro | `available` | 2026-09-13T19:41:21.996001Z |
| `moonshot/kimi-k2.6-instant` | `kimik26instant` | moonshot | `false` | pro | `available` | 2026-09-13T19:41:32.172857Z |
| `moonshot/kimi-k2.6-thinking` | `kimik26thinking` | moonshot | `false` | pro | `available` | 2026-09-13T19:41:41.981232Z |
| `nvidia/nemotron-3-super-thinking` | `nv_nemotron_3_super` | nvidia | `false` | pro | `available` | 2026-09-13T19:41:51.762788Z |
| `openai/gpt-5.4` | `gpt54` | openai | `false` | pro | `available` | 2026-09-13T19:42:01.558299Z |
| `openai/gpt-5.4-thinking` | `gpt54_thinking` | openai | `false` | pro | `available` | 2026-09-13T19:42:11.509710Z |
| `openai/gpt-5.5-thinking` | `gpt55_thinking` | openai | `false` | max | `available` | 2026-09-13T19:42:21.276041Z |
| `anthropic/claude-opus-4.7` | `claude47opus` | anthropic | `false` | max | `available` | 2026-09-13T19:42:31.150156Z |
| `anthropic/claude-opus-4.7-thinking` | `claude47opusthinking` | anthropic | `false` | max | `available` | 2026-09-13T19:42:40.973299Z |
| `anthropic/claude-sonnet-4.6` | `claude46sonnet` | anthropic | `false` | pro | `available` | 2026-09-13T19:42:50.705736Z |
| `anthropic/claude-sonnet-4.6-thinking` | `claude46sonnetthinking` | anthropic | `false` | pro | `available` | 2026-09-13T19:43:00.501355Z |
| `openai/gpt4o` | `gpt4o` | openai | `false` | unknown | `available` | 2026-09-13T19:43:10.313839Z |
| `openai/gpt41` | `gpt41` | openai | `false` | unknown | `available` | 2026-09-13T19:43:20.087766Z |
| `openai/gpt5` | `gpt5` | openai | `false` | unknown | `available` | 2026-09-13T19:43:29.980505Z |
| `openai/gpt5-thinking` | `gpt5_thinking` | openai | `false` | unknown | `available` | 2026-09-13T19:43:39.777875Z |
| `openai/gpt51` | `gpt51` | openai | `false` | unknown | `available` | 2026-09-13T19:43:49.654946Z |
| `openai/gpt51-thinking` | `gpt51_thinking` | openai | `false` | unknown | `available` | 2026-09-13T19:43:59.444670Z |
| `openai/gpt51-low-thinking` | `gpt51_low_thinking` | openai | `false` | unknown | `available` | 2026-09-13T19:44:09.236517Z |
| `openai/gpt5-mini` | `gpt5_mini` | openai | `false` | unknown | `available` | 2026-09-13T19:44:19.057906Z |
| `openai/gpt5-nano` | `gpt5_nano` | openai | `false` | unknown | `available` | 2026-09-13T19:44:28.963979Z |
| `openai/gpt5-pro` | `gpt5_pro` | openai | `false` | unknown | `available` | 2026-09-13T19:44:38.732226Z |
| `openai/gpt52` | `gpt52` | openai | `false` | unknown | `available` | 2026-09-13T19:44:48.500963Z |
| `openai/gpt52-thinking` | `gpt52_thinking` | openai | `false` | unknown | `available` | 2026-09-13T19:44:58.359725Z |
| `openai/gpt52-pro` | `gpt52_pro` | openai | `false` | unknown | `available` | 2026-09-13T19:45:08.073759Z |
| `openai/gpt55` | `gpt55` | openai | `false` | unknown | `available` | 2026-09-13T19:45:18.149763Z |
| `anthropic/claude2` | `claude2` | anthropic | `false` | unknown | `available` | 2026-09-13T19:45:28.333859Z |
| `anthropic/claude37sonnetthinking` | `claude37sonnetthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T19:45:38.151693Z |
| `anthropic/claude40sonnetthinking` | `claude40sonnetthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T19:45:47.891928Z |
| `google/gemini25pro` | `gemini25pro` | google | `false` | unknown | `available` | 2026-09-13T19:45:57.709752Z |
| `google/gemini30pro` | `gemini30pro` | google | `false` | unknown | `available` | 2026-09-13T19:46:07.544899Z |
| `google/gemini30flash` | `gemini30flash` | google | `false` | unknown | `available` | 2026-09-13T19:46:17.361196Z |
| `google/gemini30flash-high` | `gemini30flash_high` | google | `false` | unknown | `available` | 2026-09-13T19:46:27.339685Z |
| `google/gemini35flash` | `gemini35flash` | google | `false` | unknown | `available` | 2026-09-13T19:46:37.129083Z |
| `google/gemini35flash-medium` | `gemini35flash_medium` | google | `false` | unknown | `available` | 2026-09-13T19:46:47.141748Z |
| `google/gemini35flash-high` | `gemini35flash_high` | google | `false` | unknown | `available` | 2026-09-13T19:46:57.006982Z |
| `x-ai/grok` | `grok` | x-ai | `false` | unknown | `available` | 2026-09-13T19:47:06.905199Z |
| `anthropic/claude40opus` | `claude40opus` | anthropic | `false` | unknown | `available` | 2026-09-13T19:47:16.854493Z |
| `anthropic/claude40opusthinking` | `claude40opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T19:47:26.721724Z |
| `anthropic/claude41opus` | `claude41opus` | anthropic | `false` | unknown | `available` | 2026-09-13T19:47:37.188095Z |
| `anthropic/claude41opusthinking` | `claude41opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T19:47:47.004911Z |
| `anthropic/claude45opus` | `claude45opus` | anthropic | `false` | unknown | `available` | 2026-09-13T19:47:56.808023Z |
| `anthropic/claude45opusthinking` | `claude45opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T19:48:06.573757Z |
| `anthropic/claude46opus` | `claude46opus` | anthropic | `false` | unknown | `available` | 2026-09-13T19:48:16.371324Z |
| `anthropic/claude46opusthinking` | `claude46opusthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T19:48:26.148309Z |
| `anthropic/claude45sonnet` | `claude45sonnet` | anthropic | `false` | unknown | `available` | 2026-09-13T19:48:35.875010Z |
| `anthropic/claude45sonnetthinking` | `claude45sonnetthinking` | anthropic | `false` | unknown | `available` | 2026-09-13T19:48:45.706339Z |
| `anthropic/claude45haiku` | `claude45haiku` | anthropic | `false` | unknown | `unavailable` | 2026-09-13T19:48:55.515118Z |
| `anthropic/claude45haikuthinking` | `claude45haikuthinking` | anthropic | `false` | unknown | `unavailable` | 2026-09-13T19:48:58.037304Z |
| `moonshot/kimik2thinking` | `kimik2thinking` | moonshot | `false` | unknown | `available` | 2026-09-13T19:49:02.031019Z |
| `moonshot/kimik25thinking` | `kimik25thinking` | moonshot | `false` | unknown | `available` | 2026-09-13T19:49:13.362379Z |
| `x-ai/grok4` | `grok4` | x-ai | `false` | unknown | `available` | 2026-09-13T19:49:23.571782Z |
| `x-ai/grok4nonthinking` | `grok4nonthinking` | x-ai | `false` | unknown | `available` | 2026-09-13T19:49:33.430334Z |
| `x-ai/grok41reasoning` | `grok41reasoning` | x-ai | `false` | unknown | `available` | 2026-09-13T19:49:43.651497Z |
| `x-ai/grok41nonreasoning` | `grok41nonreasoning` | x-ai | `false` | unknown | `available` | 2026-09-13T19:49:53.457459Z |
| `openai/o4mini` | `o4mini` | openai | `false` | unknown | `available` | 2026-09-13T19:50:09.734470Z |
| `openai/o3pro` | `o3pro` | openai | `false` | unknown | `available` | 2026-09-13T19:50:19.657101Z |
